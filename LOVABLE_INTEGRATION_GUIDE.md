...
This guide details step-by-step how to connect **Lovable AI** to your **JobStart** project using **Supabase Deno Edge Functions**.
...
```
 ┌────────────────────────┐      ┌─────────────────────────┐      ┌─────────────────────────────┐
 │  JobStart Frontend UI  │ ──── │   FastAPI Backend API   │ ──── │  Supabase Edge Functions    │
...
4. Responses (replies, intents, candidate evaluations) stream back to JobStart.
...
## 🔄 Step 3: Triggering Lovable AI from JobStart
...
- **Deno Edge Function**: [`supabase/functions/lovable-whatsapp-agent/index.ts`](file:///Users/yasiru/Desktop/Business/JobStart/supabase/functions/lovable-whatsapp-agent/index.ts)
- **Backend Lovable Connector**: [`backend/app/services/lovable_agent.py`](file:///Users/yasiru/Desktop/Business/JobStart/backend/app/services/lovable_agent.py)
- **Lovable API Endpoint**: [`backend/app/api/v1/ai.py`](file:///Users/yasiru/Desktop/Business/JobStart/backend/app/api/v1/ai.py#L95)
- **Config Settings**: [`backend/app/core/config.py`](file:///Users/yasiru/Desktop/Business/JobStart/backend/app/core/config.py#L53)
