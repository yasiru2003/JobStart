    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted">Platform performance, hiring velocity, and revenue analytics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-5">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-2">12,480</h2>
        ...
        <div className="card p-5">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-2">1,840</h2>
          <p className="text-xs text-emerald-600 font-semibold mt-1 flex items-center gap-1">
        ...
        <div className="card p-5">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-2">18 Days</h2>
          <p className="text-xs text-emerald-600 font-semibold mt-1 flex items-center gap-1">
