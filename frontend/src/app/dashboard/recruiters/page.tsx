...
const initialStaff = [
  {
    ...
    email: 'kavinda.fernando@wso2.com',
    ...
    company: 'WSO2 Lanka',
    assignedJobs: 4,
    candidatePipeline: 32,
    interviewsConducted: 45,
    hireSuccessRate: '94%',
    status: 'Active Staff',
    jobsList: ['Senior React Developer', 'DevOps & Cloud Architect', 'Senior Full Stack Engineer', 'Data Analyst Specialist'],
  },
  {
    id: '2',
    name: 'Nalaka Bandara',
    email: 'nalaka.bandara@wso2.com',
    ...
    company: 'WSO2 Lanka',
    assignedJobs: 3,
    candidatePipeline: 21,
    interviewsConducted: 38,
    hireSuccessRate: '90%',
    status: 'Active Staff',
    jobsList: ['Lead UI/UX Designer', 'Software Architect', 'QA Automation Lead'],
  },
  {
    id: '3',
    name: 'Dinithi Abeysekara',
    email: 'dinithi.abeysekara@wso2.com',
  ...
  },
  {
    ...
    company: 'WSO2 Lanka',
    assignedJobs: 3,
    candidatePipeline: 16,
    interviewsConducted: 24,
    hireSuccessRate: '89%',
    status: 'Active Staff',
    jobsList: ['HR Operations Manager', 'Recruitment Specialist'],
  },
]
