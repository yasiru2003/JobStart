...
class JobPosting(Base):
    ...
    salary_min: Mapped[Optional[int]] = mapped_column(Integer)  # LKR
    salary_max: Mapped[Optional[int]] = mapped_column(Integer)  # LKR
    skills_required: Mapped[list] = mapped_column(JSONB, default=list)
    is_remote: Mapped[bool] = mapped_column(Boolean, default=False)
    experience_required: Mapped[Optional[str]] = mapped_column(String(50))
